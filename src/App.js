		...
		<div className="app">
			<header>
				<div className="header-logo-container">
					<img
						onClick={() => setIsContactPage(false)}
				...
				<div>
					...
					>
						<div className="cta-left">
							...
							<p>
								{" "}
								Our team of experts will help you navigate the vast sea of the internet and chart a
								course to success.
							</p>
					...
					<section className="tag-line">
						<div className="hero">
							<div className="hero-text">
								...
								<p>
									Navigating the digital seas can be daunting, especially when your online
									lighthouse—your website—no longer guides your ideal clientele to your shores.
								</p>
								<p>
									Your website should be a true reflection of your unique vision, a beacon
									attracting your dream clients amidst the fog of online noise. You deserve better
									than someone selling you a re-packaged wordpress template, shopify or wix site.
								</p>
								<p>
									HarbourView Designs is your compass in the vast digital ocean, offering you a
									website that not only stands out but also sets the course for your business
									growth, making waves in your industry and genuinely impacting your audience.
								</p>
							</div>
					...
					<section>
						<div className="services-container">
							<div className="service-copy">
								...
								<p>
									Our bespoke website design service isn't just about creating a site; it's about
									crafting an online identity that truly encapsulates the essence of your brand.
								</p>
								<p>
									With a blend of aesthetic appeal and functional design, we ensure your website
									stands out in the vast sea of the internet.
								</p>
							</div>
							<div className="service-copy">
								...
								<p>
									From the foundational code to the user-facing interface, our development process
									is like a well-charted map.
								</p>
								<p>
									We use cutting-edge technologies to build websites that are not only visually
									stunning but also robust, secure, scalable and responsive.
								</p>
							</div>
							<div className="service-copy">
								...
								<p>
									Our hosting solutions offer unparalleled security, speed, and uptime, ensuring
									your website is accessible to your audience anytime, anywhere
								</p>
							</div>
						</div>
					</section>
					<section ref={portfolioRef} className="portfolio">
						<div className="portfolio-header">
							<h2>Our Work</h2>
							<p>
								We've had the pleasure of working with a diverse range of clients, from small
								businesses to large corporations. Here are some of the projects we've completed.
							</p>
						</div>
						...
						<div className="products-container">
							<div className="product">
								...
								<div className="product-text">
									<p>
										At HarbourView Designs, we don't do one-size-fits-all. Our websites are
										handcrafted, ensuring a dynamic, responsive, and modern web presence that stands
										out from the sea of template-based sites.
									</p>
									<p>
										Say goodbye to the limitations of platforms like Wix, Shopify, or WordPress
										templates, and hello to a fully customizable digital landscape that truly
										reflects your brand's uniqueness and vision.
									</p>
								</div>
							...
							<div className="product">
								...
								<div className="product-text">
									<p>
										Is your website outdated, slow, or not mobile-friendly? We can help. Our team of
										experts will revamp your existing site, ensuring it's modern, responsive, and
										functional.
									</p>
									<p>
										We'll work with you to identify areas for improvement and implement solutions
										that enhance your site's performance, user experience, and visual appeal.
									</p>
								</div>
								<button onClick={showContactForm}>Learn More</button>
							</div>
							<div className="product">
								...
								<div className="product-text">
									<p>
										Your website deserves a safe harbor. Our hosting solutions offer unparalleled
										security, speed, and uptime, ensuring your site is accessible to your audience
										anytime, anywhere. We'll take care of the hosting and domain registration.
									</p>
									<p>
										With our reliable hosting services, you can rest easy knowing your digital
					...
					>
						<h2>
							Life is beautiful and fleeting - don't spend it wrestling with websites. Leave the
							complexities to us, and focus on what truly matters.
						</h2>
					</section>
